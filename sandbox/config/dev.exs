...
config :sandbox, SandboxWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "4UcGH/2vQ6vtzRKurh1hj+PWO2BHPcAN2cPfNWwfBVE4OuIqY+ycJqkQyKCwB7th",
  watchers: [
...
config :sandbox, SandboxWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/sandbox_web/router\.ex$"E,
      ~r"lib/sandbox_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
