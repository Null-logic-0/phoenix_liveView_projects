defmodule SandboxWeb.SandboxLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash}>
      <h1 class="text-center text-3xl font-bold">Build A Sandbox</h1>
      <div id="sandbox">
        <form phx-change="calculate" phx-submit="get-qoute">
          <div class="fields">
            <div>
        ...
        <div :if={@price} class="quote">
          Get your personal beach today for only {Number.Currency.number_to_currency(@price)}
        </div>
      </div>
    </Layouts.app>
    """
  ...
  def handle_event("get-qoute", _, socket) do
